...
var kuesioner = {
    ...
    'rating': {
      'tambahPertanyaan': function() {
        ...
        for (x = 1; x < 999; x++) {
          if (_('li_' + x) === null) {
            ...
            // buatkan isian untuk nilai rating minimal dan maksimalnya
            i = _e('input');
            i.id = 'min_' + x;
            i.type = 'number';
            i.className = 'form-control';
            i.placeholder = 'Nilai peringkat minimal';
            i.setAttribute('style', 'width: 200px; display: inline');
            i.setAttribute('onblur', 'kuesioner.rating.simpanPertanyaan(' + x + ')');
            li.appendChild(i);
            li.appendChild(document.createTextNode(' '));
            ...
            i.type = 'number';
            i.className = 'form-control';
            i.placeholder = 'Nilai peringkat maksimal';
            i.setAttribute('style', 'width: 200px; display: inline');
            i.setAttribute('onblur', 'kuesioner.rating.simpanPertanyaan(' + x + ')');
            li.appendChild(i);
            li.appendChild(document.createTextNode(' '));
      ...
      'tampilkanFormInputPertanyaan': function() {
        ...
        i.placeholder = 'Nilai peringkat minimal';
        i.setAttribute('style', 'width: 200px; display: inline');
        i.setAttribute('onblur', 'kuesioner.rating.simpanPertanyaan(1)');
        li.appendChild(i);
        li.appendChild(document.createTextNode(' '));
    ...
    'simpanJudul' : function() {
      ...
      req.done(function(data) {
          ...
          if (j.jenis_skala === "likert") {
            ...
            input.setAttribute('style', 'display: inline; width: 400px');
            input.setAttribute('onblur', 'kuesioner.rating.simpanPilihanJawaban()');
            li.appendChild(input);
            li.appendChild(document.createTextNode(' '));
            ...
            input.className = 'form-control';
            input.type = 'number';
            input.placeholder = 'Nilai rating maksimal';
            input.setAttribute('style', 'display: inline; width: 400px');
            input.setAttribute('onblur', 'kuesioner.rating.simpanPilihanJawaban()');
            li.appendChild(input);
            li.appendChild(document.createTextNode(' '));
