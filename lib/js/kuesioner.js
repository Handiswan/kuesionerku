var kuesioner = {
    'likert': {
        'simpanJudul': function() {
            if (kosong($("#judul")) === true) {
                alert("Judul masih kosong! Harap perbaharui");
                return false;
            }
            var req = $.ajax({
    ...
    'tampilkanFormDataIsianResponden': function() {
        ...
        var H = _e('h2');
        H.innerHTML = "Kustomisasi data responden yang Anda perlukan";
        box.appendChild(H);
        ...
        input.type = "text";
        input.setAttribute(
            "onblur", "kuesioner.simpanKostumisasiDataResponden()"
        );
        input.className = "form-control";
        ...
        select.setAttribute(
            "onchange", "kuesioner.simpanKostumisasiDataResponden()"
        );
        ...
        hapus.setAttribute(
            "onclick", "kuesioner.hapusKostumisasiDataResponden"
        );
        ...
        selesai.setAttribute("onclick", "kuesioner.tampilkanURLKuesioner()");
        selesai.innerHTML = "SELESAI";

        box.appendChild(selesai);
    },
    'simpanKostumisasiDataResponden': function() {
        var r = $.ajax({
            url: '../ajax/simpanKostumisasiDataResponden.php',
            method: 'post',
            data: {
                'kuesioner_id': $("#listKostumisasiDataResponden").attr("kuesioner_id"),
