<div class="row" style="margin:0">
  <div class="col-sm-3 col-md-2 sidebar" style="background-color:#f5f5f5; height:100%;position:fixed;width:20%">
	<ul class="nav nav-sidebar" style="margin:-15px;margin-top:0px">
		<li class="animated bounceInDown active">
		...
		<li class="animated bounceInLeft active">
